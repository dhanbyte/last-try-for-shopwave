...
const CATEGORY_SUBCATEGORIES: Record<BaseCategory, string[]> = {
...
export default function AddProductPage() {
  ...
  const categoryOptions = useMemo(() => CATEGORY_SUBCATEGORIES, [])
  ...
  useEffect(() => {
    ...
    loadVendorProfile().catch((error) => console.error(error))
    hydrateEditState()
  }, [])
