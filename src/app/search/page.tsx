...
function SearchContent() {
  ...
  const generateSEOData = () => {
    ...
    if (q) {
      return {
        title: `${q} - Search Results | ShopWave`,
        description: `Find ${q} at best prices on ShopWave. Free delivery across India!`
      }
    }
    
    if (category && subcategory) {
      return {
        title: `${subcategory.replace(/-/g, ' ')} - ${category} | ShopWave`,
        description: `Shop ${subcategory.replace(/-/g, ' ')} in ${category} category at best prices. Free delivery!`
      }
    }
    
    if (category) {
      return {
        title: `${category} Products - Best Prices | ShopWave`,
        description: `Shop ${category} products at lowest prices on ShopWave. Free delivery across India!`
      }
    }
    
    return {
      title: 'Search Products - ShopWave | Best Prices Online',
      description: 'Search and shop products at best prices on ShopWave. Free delivery across India!'
    }
  }
